...
from Algorithms.Optimization.Evolutionary.BoundsConfiguration import GeneConfiguration
from Algorithms.Optimization.Evolutionary.Operators.RouletteWheelSelection import RouletteSelection
from Algorithms.Optimization.Evolutionary.Operators.TournamentSelection import TournamentSelection


class GeneticAlgorithm:
    def __init__(self, population_size, gene_configuration, fitness_function,
                 selection_op, crossover_op, mutator, survival_strategy, individual_type, generations=100):
        """
        ...
        self.selector = selection_op
        self.crossover = crossover_op
        self.mutator = mutator
        self.generations = generations
        self.survival_op = survival_strategy
    ...
    def initialize_population(self):
        ...
        self.population = np.array([self.individual_class(name="Alpha", values=self.gene_config.min_values,
                                        fitness_function=self.fitness_function, mutator=self.mutator) for _ in
    ...
    def select_parents(self):
        ...
        """
        selected_parents = self.selector.select_parents(self.population, self.population_size)
...
if __name__ == "__main__":
    ...
    survival_strat = EliteSurvival(elitism_count=2)
